...
:root {
  ...
  --c-diamond:   url('https://i.ibb.co/ZpJqvt5d/white.png');
  --c-sapphire:  url('https://i.ibb.co/4nGkn3HP/sapphire.png');
  --c-emerald:   url('https://i.ibb.co/0pVz7WV5/green.png');
  --c-ruby:      url('https://i.ibb.co/wZ9gmt1p/red.png');
  --c-onyx:      url('https://i.ibb.co/y72gvDj/black.png');
  --c-gold:      url('https://i.ibb.co/PZ1dZDyH/gold.png');
  
  --glow-warm: 0 0 12px rgba(230, 180, 100, 0.35);
...
/* 📱 舞台恆為手機比例：原 @media(max-width:430px) 規則已常駐生效 */
  ...
  /* 核心遊戲區：覆蓋 inline gap:12px 的容器 */
  .shell > div[style*="display: flex"][style*="gap: 12px"] {
    gap: 4px !important;
    flex: 1 !important;
  ...
  #guide-actions > div:first-child { display: none !important; }
  ...
  .token-container-cell { padding: 1px !important; gap: 2px !important; }
  .token-btn { width: 18px !important; height: 18px !important; background-size: 13px 13px !important; }
  .token-count-label { font-size: 0.42rem !important; }
 ...
 .noble-card { min-width: 0 !important; max-width: calc((var(--stage-w, 100vw) - 86px) / 4) !important; width: calc((var(--stage-w, 100vw) - 86px) / 4) !important; height: calc((var(--stage-w, 100vw) - 86px) / 4) !important; flex-shrink: 0 !important; }
  ...
  .grid-4 {
    flex: 0 0 auto !important;          /* 列高 = 卡牌內容高度 */
    min-height: 0 !important;
    display: grid !important;
    grid-template-columns: repeat(4, 1fr) !important;
    grid-template-rows: none !important; /* 不再強制撐滿 */
    gap: 3px !important;
  }
  ...
  #cap-txt { font-size: 0.46rem !important; margin-top: 1px !important; }
   ...
   /* 首席輔助官面板 - 手機版 */
 #guide-assistant-container {
    width: calc((var(--stage-w, 100vw) - 86px) / 4) !important;
    min-width: 0 !important;
    max-width: calc((var(--stage-w, 100vw) - 86px) / 4) !important;
    flex-shrink: 0 !important;
  ...
  /* 保留手牌區：覆蓋 inline min-width:320px */
  #guide-reserved {
    flex: 2.5 !important;
    min-width: 0 !important;
    padding: 3px !important;
  ...
  .modal { max-width: 100% !important; padding: 14px !important; max-height: 88dvh !important; overflow-y: auto !important; }
