...
@media (max-width: 430px) {
 ...
 .noble-card { min-width: 0 !important; max-width: calc((100vw - 86px) / 4) !important; width: calc((100vw - 86px) / 4) !important; height: calc((100vw - 86px) / 4) !important; flex-shrink: 0 !important; }
 ...
 #guide-assistant-container {
    ...
    max-width: calc((100vw - 86px) / 4) !important;
    flex-shrink: 0 !important;
